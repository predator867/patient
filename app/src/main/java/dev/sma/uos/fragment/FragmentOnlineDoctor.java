...
public class FragmentOnlineDoctor extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_online_doctore, container, false);
    ...
    private void fetchSubjects() {
        ...
        Query query =
                firestore.collection(Common.DOCTOR)
                        .whereEqualTo(Common.DOCTOR_ONLINE_STATUS, "Online");
